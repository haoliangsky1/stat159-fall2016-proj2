...
* packages used
    The different models used either the *glmnet* or the *pls* package. *glmnet* was applicable for Lasso and Ridge Regression. *pls* was applicable for Principle Component and Partial Least Squares Regression.
